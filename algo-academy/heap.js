...
class maxHeap{
    ...
    heapifyDown() {
        ...
        while(this.data[this.getLeftChildIndex(currentIdx)] !== undefined) {
            let biggestChildIndex = this.getLeftChildIndex(currentIdx);
            ...
            if(this.data[this.getRightChildIndex(currentIdx)] !== undefined && this.data[this.getRightChildIndex(currentIdx)] > this.data[this.getLeftChildIndex(currentIdx)]) {
                biggestChildIndex = this.getRightChildIndex(currentIdx)
            }

            if(this.data[currentIdx] < this.data[biggestChildIndex]) {
                this.swap(currentIdx, biggestChildIndex); 
            } else {
                return;
            }
        }
